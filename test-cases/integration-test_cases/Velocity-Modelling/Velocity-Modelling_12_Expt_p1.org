...
* Test Steps
  ...
  +  Check the functionality of the Standard Deviation's input button
     by entering dummy values.
 
* Expected result

  +  Simulation page should be displayed on the screen
  +  The input button to enter the standard deviation  should function
     appropriately.
