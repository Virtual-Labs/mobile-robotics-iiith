...
* Test Steps
  ...
  +  Check the "Range Slider" that changes the Error variance.

* Expected result

  + Simulation page should be displayed on the screen.
  + The user should be able to change the Error variance which changes
    the window of the probability density function.
