...
$css_js   = "http://deploy.virtual-labs.ac.in/labs/cse17/"; 
$lab_url  = "http://deploy.virtual-labs.ac.in/labs/cse17/index.php";
$exp_url  =  "http://deploy.virtual-labs.ac.in/labs/cse17/montecarlolocalization/index.php";
$base_url = $exp_url;
